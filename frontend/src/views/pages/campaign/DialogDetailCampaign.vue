    ...
    maximizable modal :contentStyle="{ height: '300px' }">
            ...
            <TabPanel header="CAMPAGNES ENVOY&Eacute;ES">
                <DataTable 
                    ...
                    <Column field="contact.lastName" header="Nom" :expander="true" style="min-width: 200px"></Column>
                    <Column field="contact.firstName" header="Prenom" :expander="true" style="min-width: 200px"></Column>
