    ...
    <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
      ...
      <div class="overflow-x-auto">
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            <tr class="border-b dark:border-gray-700" v-for="contact in contacts" :key="contact.id">
              <th
                scope="row"
      ...
      <PaginatorItem :rows="pageable.limit" :totalRecords="totalRecords" :rowsPerPageOptions="rowsPerPageOptions" @page="handlePageChange"/>
    </div>
  </div>
</template>
