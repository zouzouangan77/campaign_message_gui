...
const containerClass = computed(() => {
  return {
    'layout-theme-light':
      typeof layoutConfig.darkTheme.value === 'string' && layoutConfig.darkTheme.value === 'light',
    'layout-theme-dark':
      typeof layoutConfig.darkTheme.value === 'string' && layoutConfig.darkTheme.value === 'dark',
    'layout-overlay':
      typeof layoutConfig.menuMode.value === 'string' && layoutConfig.menuMode.value === 'overlay',
    'layout-static':
      typeof layoutConfig.menuMode.value === 'string' && layoutConfig.menuMode.value === 'static',
